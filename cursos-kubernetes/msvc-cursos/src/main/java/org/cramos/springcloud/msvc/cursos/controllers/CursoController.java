package org.cramos.springcloud.msvc.cursos.controllers;

import feign.FeignException;
import javax.validation.Valid;
import org.cramos.springcloud.msvc.cursos.services.CursoService;
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.NO_CONTENT)
                    .body(Collections.singletonMap("mensaje", "No existe el usuario por " +
                            "el id o error en la comuniacion: " + e.getMessage()));
        }
        if (o.isPresent()) {
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.NO_CONTENT)
                    .body(Collections.singletonMap("mensaje", "No se pudo crear el usuario " +
                            "o error en la comuniacion: " + e.getMessage()));
        }
        if (o.isPresent()) {
            return ResponseEntity.status(HttpStatus.CREATED).body(o.get());
        }
